 ...
 * Generated at: 2026-04-17T15:04:50.796Z
 * Brand: Broadstroke
 */
  ...
  return (
    <IKBProvider config={ikbConfig}>
      <BrandProvider brand={brandConfig} contact={contactConfig} social={socialConfig}>
        ...
        {/* ProductsSection removed - not available in shared components */}
        
        {/* Carbonless Form Solutions — 2, 3, & 4-Part Options (CTAs rendered within) */}
        <ServicesSection services={content.services} />
        
        {/* Options to Fit Your Needs (CTAs rendered within) */}
        <BenefitsSection benefits={content.benefits} />
        
        {content.comparison && <ComparisonTable comparison={content.comparison} promoCode={''} />}
        {content.howItWorks ? <HowItWorksSection howItWorks={content.howItWorks} /> : <HowItWorksSection />}
        
        {/* Why Businesses Choose Broadstroke for Carbonless Forms (CTAs rendered within) */}
        ...
        {/* Ready to streamline your form documentation? (Footer CTA) */}

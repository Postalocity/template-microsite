...
describe('generate-site CLI', () => {
  describe('CLI Arguments Parsing', () => {
    ...
    it('should parse --brand and --service flags', () => {
    ...
    it('should parse brand/service format', () => {
      const options = parseArgs(['postalocity/credit-repair']);
  ...
  describe('Generated Site Config', () => {
    it('should have valid config.json structure', () => {
